...
export const Header = () => {
  ...
  return (
    <header className={`h-16 absolute mt-10 w-full  z-50 flex items-center  ${showSearchField ? "justify-end" : "justify-between"} px-10 transition-all duration-500`}>
       ...
       <h2 className={`font-street text-white text-xl tracking-widest drop-shadow-xl break-words whitespace-normal  ${showSearchField ? "hidden " : "block max-w-[60%] animate-fadeIn ml-2"}`}>{city}</h2>
