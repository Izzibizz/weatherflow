...
const App = () => {
  return (
    <div className=" w-screen min-h-screen max-w-screen h-screen bg-gradient-to-r from-[#0c1647] to-[#397495] flex flex-col justify-center items-center">
      <img src="/weatherflow-1.png" alt="logo" className="absolute top-10 tablet:top-6 right-2 tablet:right-6 tablet:w-1/3 z-30 hidden tablet:block"/>
      <h1 className="font-heading text-white absolute top-32 right-10 hidden tablet:block">We Follow the Flow of the Weather</h1>
